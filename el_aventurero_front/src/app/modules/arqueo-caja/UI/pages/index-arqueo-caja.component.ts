...
import { DetalleArqueoComponent } from '../../components/detalle-arqueo/detalle-arqueo.component';
...
export class IndexArqueoCajaComponent implements OnInit {
  ...
  arqueoIdSeleccionado: number | null = null;
  ...
  openDetalleModal(arqueoId: number): void {
    this.arqueoIdSeleccionado = arqueoId;
    this.showDetalleModal = true;
  }

  onDetalleModalClosed(): void {
    this.showDetalleModal = false;
    this.arqueoIdSeleccionado = null;
  }

  onArqueoActualizado(): void {
    this.cargarDatos();
    this.verificarArqueoDelDia();
    this.showDetalleModal = false;
    this.arqueoIdSeleccionado = null;
